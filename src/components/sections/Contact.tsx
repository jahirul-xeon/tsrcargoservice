      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-[1fr_1.1fr] md:px-12">
        ...
        <div className="reveal" data-reveal>
          ...
          <h2 className="mt-4 font-display text-3xl font-semibold tracking-tight text-ink-900 md:text-4xl">
            Connect with our enterprise service desk.
          </h2>
          <p className="mt-6 text-base leading-relaxed text-steel-600">
            Speak with a senior service specialist and request a tailored operational assessment.
          </p>

          {/* Contact details as glass chips */}
          <div className="mt-8 grid gap-4">
            {[
              { k: 'Phone', v: '+1 (212) 555-0148' },
              { k: 'Email', v: 'service@aureliaglobal.com' },
              { k: 'Address', v: '489 Meridian Avenue, New York, NY' },
              { k: 'Working Hours', v: 'Mon - Sat: 08:00 - 22:00 EST' },
            ].map((row) => (
              <div
                key={row.k}
        ...
        >
          ...
          <div className="relative rounded-[31px] bg-white/35 p-8 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.65)]">
            ...
            <div className="relative grid gap-4 md:grid-cols-2">
              ...
              <Field label="Last Name" placeholder="Okoro" type="text" />
            </div>

            <div className="relative mt-4">
              <Label>Work Email</Label>
              <Input placeholder="grace@company.com" type="email" />
            </div>

            <div className="relative mt-4">
              <Label>Service Needs</Label>
              <Textarea placeholder="Tell us about your operational requirements." />
            </div>
            ...
            <p className="relative mt-4 text-xs text-steel-600">
              We respond within <span className="font-semibold text-ink-900">1 business day</span>.
            </p>
          </div>
        </form>
      </div>
