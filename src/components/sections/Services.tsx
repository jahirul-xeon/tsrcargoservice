    ...
    <section id="services" className="relative mx-auto max-w-6xl px-6 pb-16 pt-20 md:px-12">
      ...
      <div className="reveal" data-reveal>
        ...
        <h2 className="mt-4 font-display text-3xl font-semibold text-ink-900 md:text-4xl">
          Core freight forwarding services from origin to export.
        </h2>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="relative flex items-start justify-between gap-4">
                {/* icon chip */}
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/40 backdrop-blur-md shadow-[0_10px_30px_-18px_rgba(0,160,200,0.8)] ring-1 ring-white/35 transition-transform duration-500 group-hover:scale-105">
                  <svg
              ...
              {/* bottom accent line */}
              <div className="relative mt-6 h-[2px] w-10 rounded-full bg-gradient-to-r from-electric-500/60 to-teal-500/60 opacity-60 transition-all duration-500 group-hover:w-14 group-hover:opacity-90" />
            </div>
          </article>
        ))}
      </div>
